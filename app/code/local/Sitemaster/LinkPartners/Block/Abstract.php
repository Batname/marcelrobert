...
class Sitemaster_LinkPartners_Block_Abstract extends Infortis_Brands_Block_Abstract
{
    protected $_helper;
    ...
    {
        $this->_helper = Mage::helper('sitemaster_linkpartners');
    ...
    public function getPartnerPageUrl($x12)
    {
        $x15 = '';
